...
class AWSStorageClient(StorageClient):
    ...
    def fs_connection(self, fs_connection_dict, fs_key=None):
        """
        ...
        if fs_connection_dict.account_name is None:
            ...
            prefix_url = "" #f"s3://{fs_connection_dict.account_name}/"
            ...
            # fs_connection_string = f"{default_endpoints_protocol}://{fs_connection_dict.account_name}.s3.{region}.amazonaws.com"
