    ...
    st.markdown(
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark"  style="background-color: rgb(36, 41, 47);display:flex;justify-content:space-between;">
           <div>
            ...
            <img src="https://www.tigeranalytics.com/wp-content/uploads/2023/09/TA-Logo-resized-for-website_.png" style="width:100px; height:45px;background:white;" class="navImg"/>
           </a>
           </div>
